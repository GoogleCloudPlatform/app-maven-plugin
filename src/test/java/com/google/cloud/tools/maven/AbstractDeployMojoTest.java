...
public class AbstractDeployMojoTest {
    ...
    private AbstractDeployMojo testMojo = new AbstractDeployMojo() {
        @Override
        public void execute() {
            // do nothing;
        }
    ...
    public void testGetProjectId_onlyProject() throws IllegalAccessException {
        ...
        Mockito.verify(mockLog).warn("Configuring <project> is deprecated, use <projectId> to set your Google Cloud ProjectId");
    ...
    public void testGetProjectId_onlyProjectId() throws IllegalAccessException {
        ...
        try {
            ...
            Assert.assertEquals("Configuring <project> and <projectId> is not allowed, please use only <projectId>", ex.getMessage());
        }
    }
